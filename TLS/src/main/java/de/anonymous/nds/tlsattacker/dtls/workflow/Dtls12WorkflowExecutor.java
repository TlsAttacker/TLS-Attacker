...
import anonymous.tlsattacker.tls.workflow.GenericWorkflowExecutor;
...
public class Dtls12WorkflowExecutor extends GenericWorkflowExecutor {
    ...
    private List<anonymous.tlsattacker.tls.record.Record> recordBuffer = new LinkedList<>(),
	...
	anonymous.tlsattacker.dtls.record.DtlsRecord nextRecord = receiveNextRecord();
	...
	LinkedList<anonymous.tlsattacker.tls.record.Record> recordList = new LinkedList<>();
