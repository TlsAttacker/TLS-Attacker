...
import anonymous.tlsattacker.util.Time;
...
public class ClientHelloHandler<HandshakeMessage extends ClientHelloMessage> extends
	...
	if (tlsContext.getProtocolVersion() == ProtocolVersion.DTLS12
	    ...
	    anonymous.tlsattacker.dtls.protocol.handshake.ClientHelloDtlsMessage dtlsClientHello = (anonymous.tlsattacker.dtls.protocol.handshake.ClientHelloDtlsMessage) protocolMessage;
