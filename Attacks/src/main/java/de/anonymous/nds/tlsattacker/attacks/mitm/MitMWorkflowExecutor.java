...
import anonymous.tlsattacker.tls.workflow.MessageBytesCollector;
import anonymous.tlsattacker.tls.workflow.RenegotiationWorkflowConfiguration;
import anonymous.tlsattacker.tls.workflow.TlsContext;
import anonymous.tlsattacker.tls.workflow.WorkflowContext;
...
public class MitMWorkflowExecutor {
	...
	boolean finished = pm.getClass().toString()
		.equals("class anonymous.tlsattacker.tls.protocol.handshake.FinishedMessage");
	boolean ccs = pm.getClass().toString()
		.equals("class anonymous.tlsattacker.tls.protocol.ccs.ChangeCipherSpecMessage");
